    ...
    app.use(cors({
        origin: ['http://localhost:5173','http://localhost:5174','https://os.netlabdte.com', 'http://localhost:3000', 'https://tp-rakaarrayan.vercel.app','https://backend-raka.vercel.app'],
